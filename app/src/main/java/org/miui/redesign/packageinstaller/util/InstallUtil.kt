package org.miui.redesign.packageinstaller.util
...
import org.miui.redesign.packageinstaller.InstallPackageActivity
...
object InstallUtil {
    ...
    fun copyFile2Cache(mContext: Context, mRealPackageUri: Uri): File? {
    ...
    fun processPackageUri(mContext: Context, packageUri: Uri): AppInfo? {
        ...
        when (packageUri.scheme) {
            InstallPackageActivity.SCHEME_PACKAGE -> {
                // TODO
            }
    ...
    fun installPackage(
        ...
        val installCmd = "cat $filePath | pm install -S $length"
